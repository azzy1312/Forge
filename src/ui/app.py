"""
Forge — App Shell
Root window. Owns the sidebar, topbar, and page container.
Navigation is handled here — pages are created once and swapped in/out.
"""
...
class ForgeApp(ctk.CTk):
    ...
    def __init__(self):
        ...
        self._build()
        self._navigate("convert")   # start on Convert page
    ...
    def _build(self):
        ...
        # Right-hand column: topbar + page container stacked vertically
        ...
        # Page container — all pages live in this frame, stacked on top of each other
        ...
        # Instantiate all pages (they don't build their widgets until first shown)
        ...
        # Stack every page in the same grid cell
